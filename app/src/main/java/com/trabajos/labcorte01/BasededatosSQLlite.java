...
public class BasededatosSQLlite extends SQLiteOpenHelper {
    ...
    private static final String TABLA_EVENTOS="CREATE TABLE EVENTOS(ID TEXT INTEGER PRIMARY KEY AUTOINCREMENT , FechaIni TEXT, Descripcion TEXT, Causa TEXT, ServicioAfectado TEXT,FechaFin TEXT, Indisponibilidad TEXT)";
